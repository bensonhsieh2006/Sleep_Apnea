...
path = r'/home/why/Projects/Sleep_Apnea/Sleep_Code_Data/Wav_30_68'   #Raw_Data path
year = 2021
month = 2

new_path = r'/home/why/Projects/Sleep_Apnea/Sleep_Code_Data/Wav_Combine'     #Wav_Combine path
...
for x in range(len(Date_and_ID_list)):
    ...
    if count!=1:
        ...
        data=True
        source_list=[]
        raw_path = file.full_path(path, year, month, Date_and_ID_list[x])[0]
