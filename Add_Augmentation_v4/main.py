...
ori_path = r'/home/why/Projects/Sleep_Apnea/Sleep_Code_Data/Wav_Combine'
new_path = r'/home/why/Projects/Sleep_Apnea/Sleep_Code_Data/Aug/Aug_Band'
csv_path = r'/home/why/Projects/Sleep_Apnea/Sleep_Code_Data/Temporary_Files'
year = 2021
month= 3

#Add_Background_Noise
bg_path = r'/home/why/Projects/Sleep_Apnea/Sleep_Codes/Sleep_Code_20220706/Add_Augmentation_v4/audiomentations/demo/background_noises'

#Add_Short_Noises
noise_path = r'/home/why/Projects/Sleep_Apnea/Sleep_Codes/Sleep_Code_20220706/Add_Augmentation_v4/audiomentations/demo/short_noises'
...
for x in Date_and_ID_list:
    ...
    if count!=40:
        ...
        data = selection.check_file(augmentation_type, dest_path)
